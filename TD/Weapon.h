...
#include "Placeable.h"
 ...
 class Landscape;
 /**
 \brief Родительский класс для защитных построек 

Выполняет базовые функции . Основная не виртуальная функция - обнаружение врагов .
Также контролирует уровень , радиус действия , стоимость апгрейда постройки 
 */
